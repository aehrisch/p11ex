defmodule P11ex.ECParamsTest do
  ...
  @curves [
    {:secp192r1, {1,2,840,10045,3,1,1}, <<0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x01>>},
    {:secp224r1, {1,3,132,0,33}, <<0x06, 0x05, 0x2b, 0x81, 0x04, 0x00, 0x21>>},
    {:secp256r1, {1,2,840,10045,3,1,7}, <<0x06, 0x08, 0x2a, 0x86, 0x48, 0xce, 0x3d, 0x03, 0x01, 0x07>>},
